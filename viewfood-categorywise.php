...
//if($query)
//{
 //echo $msg="Успешно добавен в количката.";   
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong>
<?php				if($query)
{
 echo $msg="Успешно добавен в количката.";   
 //echo "<script>alert('Food has been added in to the cart');</script>";   
                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                    <div class="sidebar-title white-txt">
                                        <h6>Търсене</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="потърси любимата храна..." name="searchdata"
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 food-item">
                                    <div class="food-item-wrap">
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="price-btn-block"> <span class="price"> <?php echo $row['ItemPrice'];?> лв.</span> 

<?php if($_SESSION['fosuid']==""){?>
<a href="login.php" class="btn theme-btn-dash pull-right">Поръчай</a>
<?php } else {?>
    <form method="post"> 
    <input type="hidden" name="foodid" value="<?php echo $row['ID'];?>">   
<button type="submit" name="submit" class="btn theme-btn-dash pull-right">Поръчай</button>
  </form> 
<?php }?>
                                             </div>
                                        </div>
...
<ul class="pagination" >
        <li class="page-link"><a href="?pageno=1">Първа </a></li>
        <li class="<?php if($pageno <= 1){ echo 'disabled'; } ?> page-link">
            <a href="<?php if($pageno <= 1){ echo '#'; } else { echo "?pageno=".($pageno - 1); } ?>">Предишна</a>
        </li>
        <li class="<?php if($pageno >= $total_pages){ echo 'disabled'; } ?> page-link">
            <a href="<?php if($pageno >= $total_pages){ echo '#'; } else { echo "?pageno=".($pageno + 1); } ?>">Следваща</a>
        </li>
        <li class="page-link"><a href="?pageno=<?php echo $total_pages; ?>">Последна</a></li>
    </ul>
