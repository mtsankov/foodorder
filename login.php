            ...
            <div class="breadcrumb">
               <div class="container">
                  <ul>
                     ...
                     <li><a href="#">Страница за вход</a></li>
                     <li>Вход</li>
                  </ul>
               </div>
            </div>
...
<h6 style="padding-top: 20px"><a href="forgot-password.php">Забравена парола?</a></h6> 
                                    </div>
                                 ...
                                 <div class="row">
                                    <div class="col-sm-4">
                                      <button type="submit" name="login" class="btn theme-btn"><i class="ft-user"></i>Вход</button>
                                    </div>
                                    <div class="col-sm-4">
                          <a href="registration.php" class="btn theme-btn"><i class="ft-user"></i>Регистрация</a>
