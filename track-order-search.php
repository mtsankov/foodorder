...
Няма намерен номер на поръчка.
       ...
       <?php }else {
         ...
         <p><b>Дата на поръчката :</b> <?php echo $row['OrderTime']?></p>
...
?>
 <a href="javascript:void(0);" onClick="popUpWindow('trackorder.php?oid=<?php echo htmlentities($row['Ordernumber']);?>');" title="Track order">Проследяване на поръчката</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-4 text-xs-center">
                                     ...
                                     <a href="track-order-details.php?orderid=<?php echo $row['Ordernumber'];?>" class="btn theme-btn-dash">Детайли</a> </div>
                                        </div>
                                        <!-- end:right info -->
                                    </div>
                                </div>
