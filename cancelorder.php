...
<title> Анулиране на поръчка</title>
</head>
<body>
...
<table border="1"  cellpadding="10" style="border-collapse: collapse; border-spacing:0; width: 100%; text-align: center;">
  <tr align="center">
   <th colspan="4" >Анулирай поръчката #<?php echo  $oid;?></th> 
  </tr>
  <tr>
...
<tr>
  <td colspan="2" align="center"><button type="submit" name="submit" class="btn btn-primary">Актуализиране на поръчката</button></td>
...
<p style="color:red; font-size:20px;"> Поръчката е анулирана</p>
<?php } else { ?>
  <p style="color:red; font-size:20px;"> Не можете да отмените тази поръчка. Поръчка се дотавя или е доставена</p>
