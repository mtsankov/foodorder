...
if (!empty($_POST['city'])) {
		...
		$city = FALSE;
		$errCity = "Въведете град.";
	}
	
	if (!empty($_POST['streename'])) {
		$street = htmlentities($_POST['streename']);
	} else {
		$street = FALSE;
		$errStr = "Въведете улица.";
	}
...
$query.="insert into tblorderaddresses(UserId,Ordernumber,City,StreetName, Phone,About) values('$userid','$orderno','$city','$street','$phone','$about');";
header('location: print.php?pid='.$orderno );
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        <div class="menu-widget m-b-30">
                            <div class="widget-heading">
                              ...
                              Мойте поръчки! <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular" aria-expanded="true">
...
<h6><a href="food-detail.php?fid=<?php echo $_SESSION['fid']=$row['FoodId'];?>"><?php echo $row['ItemName']?> <?php /*echo $row['ItemQty']*/?> </a></h6>
                                        ...
                                        <!-- end:col -->
                                        <div class="col-xs-12 col-sm-12 col-lg-4 pull-right item-cart-info"> <span class="price pull-left"><?php echo $total=$row['ItemPrice']?> лв. &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="cart.php?delid=<?php echo $row['frid'];?>" onclick="return confirm('Сигурен ли сте ?');";><i class="fa fa-trash" aria-hidden="true" title="Изтриване на продукта!"></i><a/></span>
                                 <?php echo  $msg;?>      </div>
                                    </div>
                                    <!-- end:row -->
                                ...
                                <div class="order-row bg-white">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group row no-gutter">
											...
											<input type="text" name="city" placeholder="Град" class="form-control"> 
											 <span class="error">* <?php echo $errCity;?></span>
											<input type="text" name="streename" placeholder="Улица/улица номер" class="form-control" > 
                                           <span class="error">* <?php echo $errStr;?></span>											
<!--<input type="text" name="flatbldgnumber"  placeholder="Номер на улица/блок" class="form-control" >
     
<input type="text" name="area"  placeholder="Квартал" class="form-control" >-->
<input type="text" name="phone"  placeholder="Телефон" class="form-control" >
<span class="error">* <?php echo $errPhone;?></span>
<input type="text" name="about" placeholder="Бележка" class="form-control"> 
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                       <h2 class="error"><strong><p>ТОТАЛ</p></strong></h2>
                                         <h3 class="value"><strong><?php echo $grandtotal = number_format($grandtotal,2, ".", "");?> лв.</strong></h3>
                                        <p>Безплатна доставка</p>
                                        <button  type="submit" name="placeorder" class="btn theme-btn btn-lg">Поръчай</button>
                                    </div>
                                </div>
                            </div>
                        </div>
