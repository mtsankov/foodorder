...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                <p><span class="primary-color"><strong></strong></span> </div>
            </p>
                            ...
                            <div class="sidebar clearfix m-b-20">
                                ...
                                <div class="main-block">
                                    <div class="sidebar-title white-txt">
                                        <h6>Търси храна</h6> <i class="fa fa-cutlery pull-right"></i> </div>
                                    <div class="input-group">
                                        <input type="text" class="form-control search-field" placeholder="Търси" name="searchdata" id="searchdata"> <span class="input-group-btn"> 
...
<a href="login.php" class="btn theme-btn-dash pull-right">Поръчай сега</a>
<?php } else {?>
    <form method="post"> 
    <input type="hidden" name="foodid" value="<?php echo $row['ID'];?>">   
<button type="submit" name="submit" class="btn theme-btn-dash pull-right">Поръчай сега</button>
  </form> 
<?php }?>
                                              </div>
                                        </div>
...
<ul class="pagination" >
        <li class="page-link"><a href="?pageno=1"> < </a></li>
        ...
        <li class="page-link"><a href="?pageno=<?php echo $total_pages; ?>"> > </a></li>
    </ul>
