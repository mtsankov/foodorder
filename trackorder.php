...
<table border="1"  cellpadding="10" style="border-collapse: collapse; border-spacing:0; width: 100%; text-align: center;">
  <tr align="center">
   <th colspan="4" >Проследяване на поръчка  #<?php echo  $orderid;?></th> 
  </tr>
  <tr>
    <th>#</th>
<th>Забележка</th>
...
if($row['fstatus'] == 'Order Confirmed'){
echo "Потвърдена!";
}
else if($row['fstatus'] == "Order Cancelled"){
echo "Отказана!";
}
else if($row['fstatus'] =="Food Delivered"){
echo "Доставена!";
}
else if($row['fstatus'] == "Food being Prepared"){
echo "Подготвя!";
}
else if($row['fstatus'] == "Food Pickup"){
...
<?php $cnt=$cnt+1;} ?>
	 ...
	 <!-- <input name="Submit2" type="submit" class="txtbox4" value="принтирай" onClick="return f3();" style="cursor: pointer;"  />-->
