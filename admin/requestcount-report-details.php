...
$tdate=$_POST['todate'];
?>
<h5 align="center" style="color:blue">Брой поръчки от дата <?php echo $fdate?> to <?php echo $tdate?></h5>
<hr />
<table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead>
<tr>
<th>S.NO</th>
<th>Всички поръчки</th>
<th>Всички непотвърдени поръчки</th>
<th>Всички потвърдени поръчки</th>
<th>Всички анулирани поръчки</th>
<th>Всички подготвени поръчки</th>
<th>Всички в процес на доствка поръчки</th>
<th>Всички доставени поръчки</th>
</tr>
</thead>
<?php
