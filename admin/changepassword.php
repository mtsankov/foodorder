...
$msg= "Успешно променена парола!"; 
} else {

$msg="Текущата парола е грешна";
}
...
?>
                            ...
                            <form name="changepassword" method="post" class="wizard-big" onsubmit="return checkpass();">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Текуща парола:</label>
                                             ...
                                             <div class="form-group row"><label class="col-sm-2 col-form-label">Нова парола:</label>
                                             ...
                                             <div class="form-group row"><label class="col-sm-2 col-form-label">Потвърди парола:</label>
