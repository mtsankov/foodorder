                                    ...
                                    <fieldset>
                                        <div class="form-group row"><label class="col-sm-2 col-form-label">Име</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Снимка</label>
                                                <div class="col-sm-10"><img src="itemimages/<?php echo $row['Image'];?>" width="200" height="150" value="<?php
												echo $row['Image'];?>"> 
                                                     </div>
                                            </div>
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Нова снимка</label>
