...
if(isset($_POST['submit']))
  {
    ...
    if ($query) {
    $msg="Администраторския профил е обновен.";
  }
  else
    {
...
?>
                            ...
                            <form id="submit" action="#" class="wizard-big" method="post" name="submit">
                                    <fieldset>
                                          <div class="form-group row"><label class="col-sm-2 col-form-label">Име:</label>
                                            ...
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Потребителско име:</label>
                                                <div class="col-sm-10"><input type="text" class="form-control" name="username" readonly="true" value="<?php  echo $row['UserName'];?>"></div>
                                            </div>
                                            
                                            <div class="form-group row"><label class="col-sm-2 col-form-label">Мобилен номер:</label>
                                                <div class="col-sm-10">
          ...
          <p style="text-align: center;"><button type="submit" name="submit" class="btn btn-primary">Обнови</button></p>
