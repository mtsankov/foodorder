...
INNER JOIN tbluser 
ON tblorderaddresses.UserId = $userid LIMIT 1");
$num=mysqli_num_rows($query);	
                                ...
                                <div class="order-row bg-white">
                                    <div class="widget-body">
                                        ...
                                        <div class="form-group row no-gutter">
											...
											<input type="text" name="streename" placeholder=<?php echo $row['StreetName'];?> class="form-control" >  
                                            <input type="text" name="flatbldgnumber" placeholder=<?php echo $row['Landmark'];?> class="form-control" >
     
<input type="text" name="area"  placeholder="Квартал" class="form-control" >
<input type="text" name="landmark" placeholder="Бележка" class="form-control"> 
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>ТОТАЛ</p>
                                        <h3 class="value"><strong><?php echo $grandtotal;?> лв.</strong></h3>
