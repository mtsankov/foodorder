...
if($query)
{
 echo "<script>alert('Продукта е добавен в количката');</script>";   
} else {
                            ...
                            <div class="widget widget-cart">
                                ...
                                <div class="widget-body">
                                    <div class="price-wrap text-xs-center">
                                        <p>ТОТАЛ</p>
                                        <h3 class="value"><strong><?php echo $row['ItemPrice'];?> лв.</strong></h3>
...
<?php } else {?>
    ...
    <input type="hidden" name="foodid" value="<?php echo $row['ID'];?>">  
                                        <button type="submit" name="submit" class="btn theme-btn btn-lg">Поръчай</button>
  </form> 
<?php }?>
                                    </div>
                                </div>
