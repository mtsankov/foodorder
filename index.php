...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <section class="hero bg-image" data-image-src="images/fast-food-e21500cbfa.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Поръчка на храна</h1>
                    <h5 class="font-white space-xs">Намерете любимия си продукт!</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-food.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount"></label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount"  name="searchdata" id="searchdata" placeholder="искам да ям...."> </div>
                            </div>
                            <button onclick="location.href='search-food.php'" type="submit" name="search" class="btn theme-btn btn-lg">Търси</button>
                        </form>
                    </div>
                    <div class="steps">
        ...
        <!--<div class="location-match text-xs-center">
            <div class="container"> <span><h1>Популярни храни: <h2><span class="primary-color"></span> </span>
            </div>
        </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Популярни тази седмица</h2></br>
                    <p class="lead">Най-лесният начин да получите любимите си продукти</p></br>
                </div>
        ...
        <section class="how-it-works">
            <div class="container">
                <div class="text-xs-center">
                    <h2>3 лесни стъпки за поръчка</h2>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Избери! </h3>
                                    <p>Меню с много разнообразни продукти.</p>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Плащане в брой при доставка!</p>
                    </div>
                </div>
            </div>
        </section>
