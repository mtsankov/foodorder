            ...
            <div class="breadcrumb">
               <div class="container">
                  <ul>
                     ...
                     <li><a href="reset-password.php">Възстаноявяване на парола</a></li>
                     <li>Възстаноявяване на парола</li>
                  </ul>
               </div>
            </div>
                              ...
                              <form action="" method="post" name="changepassword" onsubmit="return checkpass();">
                                 <div class="row">
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputEmail1">Нова парола</label>
                                       <input class="form-control" type="password" required="true" name="newpassword" placeholder="New Password">
                                    </div> </div>
                                    <div class="row">
                                    <div class="form-group col-sm-6">
                                       <label for="exampleInputPassword1">Потвърди новата парола</label>
